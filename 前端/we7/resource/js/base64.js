function base64_encode(e) {
    for (var r, a, t, o = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", c = 0, h = e.length, d = ""; c < h;) {
        ...
        if (a = e.charCodeAt(c++), c == h) {
            d += o.charAt(r >> 2), d += o.charAt((3 & r) << 4 | (240 & a) >> 4), d += o.charAt((15 & a) << 2), d += "=";
            break
        }
        t = e.charCodeAt(c++), d += o.charAt(r >> 2), d += o.charAt((3 & r) << 4 | (240 & a) >> 4), d += o.charAt((15 & a) << 2 | (192 & t) >> 6), d += o.charAt(63 & t)
    }
    return d
}
