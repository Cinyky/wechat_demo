...
util.url = function(e, t) {
    ...
    if (wx.showNavigationBarLoading(), e.showLoading && util.showLoading(), e.cachetime) {
        ...
        if (c && c.data) {
            if (c.expire > g) return e.complete && "function" == typeof e.complete && e.complete(c), e.success && "function" == typeof e.success && e.success(c), console.log("cache:" + i), wx.hideLoading(), wx.hideNavigationBarLoading(), !0;
    ...
    wx.request((_defineProperty(t = {
        ...
        if (wx.hideNavigationBarLoading(), wx.hideLoading(), t.data.errno) {
            ...
            if (e.fail && "function" == typeof e.fail) e.fail(t);
                ...
                if (null != t.data.data && t.data.data.redirect) var n = t.data.data.redirect;
                else n = "";
    ...
    this.isLeapYear = function(e) {
        ...
        var n = e;
        return n = (n = (n = (n = (n = (n = (n = (n = (n = (n = (n = (n = (n = n.replace(/yyyy|YYYY/, t.getFullYear())).replace(/yy|YY/, t.getYear() % 100 > 9 ? (t.getYear() % 100).toString() : "0" + t.getYear() % 100)).replace(/MM/, t.getMonth() > 9 ? t.getMonth() + 1 : "0" + (t.getMonth() + 1))).replace(/M/g, t.getMonth())).replace(/w|W/g, ["日", "一", "二", "三", "四", "五", "六"][t.getDay()])).replace(/dd|DD/, t.getDate() > 9 ? t.getDate().toString() : "0" + t.getDate())).replace(/d|D/g, t.getDate())).replace(/hh|HH/, t.getHours() > 9 ? t.getHours().toString() : "0" + t.getHours())).replace(/h|H/g, t.getHours())).replace(/mm/, t.getMinutes() > 9 ? t.getMinutes().toString() : "0" + t.getMinutes())).replace(/m/g, t.getMinutes())).replace(/ss|SS/, t.getSeconds() > 9 ? t.getSeconds().toString() : "0" + t.getSeconds())).replace(/s|S/g, t.getSeconds())
