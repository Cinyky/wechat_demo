...
Page({
    ...
    onLoad: function(t) {
        ...
        app.util.request({
            ...
            success: function(t) {
                ...
                var a = e.data.infortype.concat(t.data);
    ...
    tabClick: function(t) {
        var e = this;
        if (console.log(t.currentTarget.id, t.currentTarget.dataset.index), 0 == t.currentTarget.dataset.index) var a = "";
        else a = t.currentTarget.id;
        this.setData({
            page: 1,
            refresh_top: !1,
            seller: [],
