            ...
            success: function(e) {
                ...
                wx.setStorageSync("code", o), wx.getUserInfo({
                    success: function(e) {
                        ...
                        t.setData({
                            user_name: a
                        }), console.log("用户名字"), console.log(e.userInfo.nickName), console.log("用户头像"), console.log(e.userInfo.avatarUrl), app.util.request({
                            ...
                            success: function(e) {
                                ...
                                var c = e.data.openid;
                                console.log("这是用户的openid"), console.log(c), app.util.request({
                                    ...
                                    success: function(e) {
                                        console.log("这是用户的登录信息"), console.log(e), wx.setStorageSync("users", e.data), wx.setStorageSync("uniacid", e.data.uniacid), t.setData({
                                            user_id: e.data.id,
                                            user_info: e.data
                                        })
                                    }
