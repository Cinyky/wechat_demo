...
Page({
    ...
    onLoad: function (t) {
        app.pageOnLoad(this), console.log(wx.getSystemInfoSync()), share_count = 0, is_more_comment = !(is_loading_comment = !(p = 1)), this.setData({
    ...
    getCommentList: function (a) {
        var o = this;
        a && "active" != o.data.tab_comment || is_loading_comment || is_more_comment && (is_loading_comment = !0, app.request({
    ...
    submit: function (t) {
        ...
        var o = a.data.attr_group_list,
            e = [];
        for (var i in o) {
            var s = !1;
            for (var r in o[i].attr_list)
                if (o[i].attr_list[r].checked) {
                    s = {
    ...
    attrClick: function (t) {
        var o = this,
            a = t.target.dataset.groupId,
            e = t.target.dataset.id,
            i = o.data.attr_group_list;
        for (var s in i)
            if (i[s].attr_group_id == a)
                for (var r in i[s].attr_list) i[s].attr_list[r].attr_id == e ? i[s].attr_list[r].checked = !0 : i[s].attr_list[r].checked = !1;
        o.setData({
            attr_group_list: i
        });
        var n = [],
        ...
        for (var s in i) {
            var c = !1;
            for (var r in i[s].attr_list)
                if (i[s].attr_list[r].checked) {
