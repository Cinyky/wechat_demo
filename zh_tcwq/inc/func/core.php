    ...
    public function getMainMenu()
    {
        ...
        /*  $navemenu[10] = array(
          ...
          $navemenu[9] = array(
             ...
             $navemenu[8] = array(
                'title' => '<a href="index.php?c=site&a=entry&op=display&do=jfgoods&m=zh_tcwq" class="panel-title wytitle" id="yframe-8"><icon style="color:#8d8d8d;" class="fa fa-star-half-o"></icon>  积分商城</a>',
                'items' => array(
           ...
           $navemenu[13] = array(
                'title' => '<a href="index.php?c=site&a=entry&op=display&do=integral&m=zh_tcwq" class="panel-title wytitle" id="yframe-13"><icon style="color:#8d8d8d;" class="fa fa-gift"></icon>  签到管理</a>',
          ...
          $navemenu[10] = array(
           ...
           $navemenu[16] = array(
                'title' => '<a href="index.php?c=site&a=entry&op=display&do=hbdata&m=zh_tcwq" class="panel-title wytitle" id="yframe-16"><icon style="color:#8d8d8d;" class="fa fa-key"></icon>  数据统计</a>',
                'items' => array(
